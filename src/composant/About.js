  ...
  return (
    ...
    >
      ...
      <div className="content-container d-flex justify-content-center align-items-flex-start col-11 flex-wrap">
        ...
        {/* Photo */}
        <div className="photo d-flex flex-column justify-content-center align-item-center text-white   flex-grow-1 border border-2 border-black rounded-circle object-fit-cover h-25  " >
